...
export const messages = {
  es: {
    ...
    accept: 'Aceptar', reject: 'Rechazar', authError: 'No se pudo iniciar la autenticación.', syncError: 'No se pudo sincronizar la partida.',
  ...
  en: {
    ...
    accept: 'Accept', reject: 'Reject', authError: 'Authentication could not start.', syncError: 'The game could not be synchronized.',
