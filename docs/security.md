...
- Rules tests explicitly cover denied direct status/`startedAt` transitions by hosts and members, while retaining member reads of backend-created active sessions.
